...
const handleReservation = (roomInfoData) => {
  console.log('Selected Room:', roomInfoData); // 增加 log 追蹤
  selectedRoomInfo.value = { ...roomInfoData }; // 使用淺拷貝確保新的物件參考
  console.log('Current Selected Room:', selectedRoomInfo.value); // 再次 log 確認
  resetUserForm();
};
